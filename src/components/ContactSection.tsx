      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <div className="bg-olive/20 rounded-2xl p-8 border border-olive/30 backdrop-blur-sm hover:border-neon/30 transition-all duration-300 group">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <motion.button
                      ...
                      className="text-muted-gray hover:text-neon transition-colors cursor-pointer text-left"
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      className="p-1 text-muted-gray hover:text-neon transition-colors"
              ...
              <div className="space-y-3">
                <motion.button
                  ...
                  whileHover={{ scale: 1.01 }}
                  whileTap={{ scale: 0.99 }}
                  className="w-full bg-neon text-charcoal py-4 px-6 rounded-xl font-bold text-lg flex items-center justify-center gap-3 hover:bg-yellow-300 transition-all duration-300"
                >
                  <Send
                ...
                >
                  <div className="bg-charcoal/50 rounded-xl p-4 border border-muted-gray/20 space-y-2">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full bg-red-500/20 text-red-300 py-3 px-4 rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-red-500/30 transition-all duration-300 border border-red-500/30"
                    >
                    ...
                    <motion.button
                      ...
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="w-full bg-blue-500/20 text-blue-300 py-3 px-4 rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-blue-500/30 transition-all duration-300 border border-blue-500/30"
                    >
                    ...
                    <motion.button
                      ...
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="w-full bg-green-500/20 text-green-300 py-3 px-4 rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-green-500/30 transition-all duration-300 border border-green-500/30"
                    >
                      {emailCopied ? (
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <motion.div
                ...
                className="bg-charcoal/50 rounded-xl p-6 border border-muted-gray/20 hover:border-neon/30 transition-all duration-300 text-center"
              >
                <Coffee className="w-8 h-8 text-neon mx-auto mb-3" />
                <h4 className="text-lg font-bold text-off-white mb-2">
                  Response Time
                </h4>
              ...
              <div className="flex gap-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`p-4 bg-olive/20 rounded-xl border border-olive/30 hover:border-neon/30 transition-all duration-300 group ${social.color}`}
                  >
                    <social.icon className="w-6 h-6 text-muted-gray group-hover:text-current transition-colors" />
                  </motion.a>
                ))}
              </div>
            </div>
              ...
              >
                <div className="relative">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-32 h-32 bg-gradient-to-br from-neon/20 to-olive/40 rounded-full p-2 shadow-2xl shadow-neon/20 cursor-pointer transition-all duration-300 hover:shadow-neon/30"
                    title="Click to send me an email via Gmail"
                  >
                    <div className="w-full h-full bg-charcoal rounded-full flex items-center justify-center">
                      <Mail className="w-16 h-16 text-neon transition-all duration-300 hover:text-yellow-300" />
                    </div>
                  </motion.button>
                </div>
              </motion.div>
        ...
        >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            className="bg-gradient-to-r from-neon to-yellow-300 text-charcoal px-8 py-4 rounded-full font-bold text-lg hover:from-yellow-300 hover:to-neon transition-all duration-300 shadow-lg hover:shadow-neon/30"
          >
